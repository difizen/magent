...
import { MessageStatus } from '../../chat-protocol.js';
...
const MessageBase: React.FunctionComponent<MessageBaseProps> = (props) => {
  ...
  function renderMsgHeader() {
    ...
    return (
      <div className="chat-message-content-header" style={flexFlowStyle}>
        {header}
      </div>
    );
  }
  ...
  function renderMsgFooter() {
    ...
    return (
      <div className="chat-message-content-footer" style={flexFlowStyle}>
        {footer}
      </div>
    );
  }
  ...
  function renderMsgStatus() {
    ...
    if (status === MessageStatus.error) {
      return (
        <div className="chat-message-content-main-status">
          <Button
  ...
  function renderMsgMain() {
    return (
      <div className="chat-message-content-main content-main">
  ...
  return (
    <div className="chat-message" style={flexFlowStyle}>
      {renderAvatar()}
